...
from data.preprocessors.image_preprocessing.image_preprocessors import FuzzyImagePreprocessor
from models.generative_adversarial_nets.architecture import Generator, Discriminator
from models.generative_adversarial_nets.personal_trainer import GenerativeAdversarialNetPersonalTrainer
...
"""
ganpt = GenerativeAdversarialNetPersonalTrainer(g_model, d_model, training_dataloader, validation_dataloader,
                                                LOG_INTERVAL, G_MODEL_SAVE_PATH, D_MODEL_SAVE_PATH, criterion,
